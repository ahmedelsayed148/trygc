...
const ALL_FEATURES: FeatureDefinition[] = [
  ...
  { id: 'ops', label: 'OPS Command', icon: Target, description: '9-department ops tracker with tasks & subtasks' },
  { id: 'campaigns', label: 'Campaigns', icon: Target, description: '6-phase campaign lifecycle management' },
  { id: 'master-tasks', label: 'Master Tasks', icon: ClipboardList, description: 'Campaign master task hierarchy page' },
  { id: 'campaign-watch', label: 'Campaign Watch', icon: Clock, description: 'Upcoming and ongoing campaign view' },
...
const DEFAULT_ADMIN_FEATURES = ALL_FEATURES.map(f => f.id);
const DEFAULT_MEMBER_FEATURES = ['personal', 'community-team', 'ops', 'campaigns', 'master-tasks', 'campaign-watch', 'successes', 'settings'];
        ...
        <div className="bg-white dark:bg-zinc-950 rounded-3xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-6 animate-in slide-in-from-top-2 duration-200">
          ...
          <form onSubmit={handleAddUser} className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <button
                type="button"
                onClick={() => { setShowAddUser(false); setNewUserEmail(''); setNewUserName(''); }}
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                        {ALL_FEATURES.map(feature => {
                          ...
                          const disabled = !manageable || isCurrentlySaving;
